...
for i in antonio boerne poteet schertz austin dallas houston; do scp XML/$1.xml $i:HADS/XML/$FILE; done
for i in antonio boerne poteet schertz austin dallas houston; do ssh $i ls -l HADS/XML/$FILE; done
