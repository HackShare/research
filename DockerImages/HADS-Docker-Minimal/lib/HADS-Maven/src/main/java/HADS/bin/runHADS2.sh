...
for i in austin dallas houston zeus.stockton.edu 64.28.143.30; do scp XML/$1.xml $i:HADS/XML/$FILE; done
for i in austin dallas houston zeus.stockton.edu 64.28.143.30; do ssh $i ls -l HADS/XML/$FILE; done
